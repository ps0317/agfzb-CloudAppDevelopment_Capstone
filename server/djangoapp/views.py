...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://us-south.functions.appdomain.cloud/api/v1/web/PhanNgoc_djangoserver-space/dealership-package/get-reviews'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://us-south.functions.appdomain.cloud/api/v1/web/PhanNgoc_djangoserver-space/dealership-package/get-dealerships?dealerId={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://us-south.functions.appdomain.cloud/api/v1/web/PhanNgoc_djangoserver-space/dealership-package/post-review"  # API Cloud Function route
